 ...
 * @author felixfaker
 */
public class Admin_AddAccomodation extends javax.swing.JFrame {

    /**
     * Creates new form Admin_AddAccomodation
     */
     Connection connect = null;
    public Admin_AddAccomodation() {
        initComponents();
    ...
    public static void open_window() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_AddAccomodation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_AddAccomodation().setVisible(true);
            }
        });
    }
