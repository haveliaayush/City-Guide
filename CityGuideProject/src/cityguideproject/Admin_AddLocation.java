 ...
 * @author felixfaker
 */
public class Admin_AddLocation extends javax.swing.JFrame {

    /**
     * Creates new form Admin_AddLocation
     */
    Connection connect = null;
    public Admin_AddLocation() {
        initComponents();
    ...
    public static void open_window() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_AddLocation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_AddLocation().setVisible(true);
            }
        });
    }
