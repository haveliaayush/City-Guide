 ...
 * @author felixfaker
 */
public class Admin_ManageInstitutes extends javax.swing.JFrame {

    /**
     * Creates new form Admin_ManageInstitutes
     */
    Connection connect = null;
    public Admin_ManageInstitutes() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Delete Institute");
        ...
        jButton3.setText("Add Institute");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            String query = " DELETE FROM institutes WHERE i_id = ? ";
    ...
    public static void open_window() {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_ManageInstitutes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_ManageInstitutes().setVisible(true);
            }
        });
    }
